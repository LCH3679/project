	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<ul class="nav navbar-top-links navbar-right"
				...
				<li class="dropdown">
				<a class="dropdown-toggle" href="/board/main">메인</a>
				</li>
				...
				<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">언어</a>
					<ul class="dropdown-menu dropdown-tasks">
						<li><a href="#">자바</a></li>
						<li><a href="#">c언어</a></li>
						<li><a href="#">파이썬</a></li>
				...
				<li class="dropdown">
				<a class="dropdown-toggle" href="/board/list">토론게시판</a>
				</li>
				<li class="dropdown">
				...
				<ul class="dropdown-menu dropdown-user" style="left:450px;">
						<li><a href="/board/mget"><i class="fa fa-user fa-fw"></i> 회원정보</a></li>
						<li><a href="/board/mregister"><i class="fa fa-gear fa-fw"></i> 회원가입</a></li>
